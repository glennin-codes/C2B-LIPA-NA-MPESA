...
const stkPush=async(req,res)=>{
 ...
 paymentData={...paymentData, email:req.body.email, phone:req.body.phone,productName:req.body.productName,amount:req.body.amount}
...
console.log(stkCallback.CallbackMetadata)
 ...
 paymentData={...paymentData, datePayed:Date.now(),trnx_id,merchantRequestId}

const sucessfulPayment = await Payments.create(paymentData)
if(sucessfulPayment){
